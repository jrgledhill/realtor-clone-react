...
furnished, address, description, offer, regularPrice,
discountedPrice, images, } = formData;
function onChange() {}
return (
         ...
         <form>
            ...
            <div>
                ...
                <input type="number" id="bedrooms" value=
                    ...
                    transition duration ease-in-out focus:text-gray-700
            ...
            <p className="text-lg mt-10 font-semibold">Parking spot</p>
            <div className="flex">
            ...
            {onChange} placeholder="Address" required 
            className="w-full px-4 py-2 text=xl text-gray-700
            bg-white border border-gray-300 rounded transition
            duration-150 ease-in-out focus:text-gray-700
            focus:bg-white focus:border-slate-600 cursor-pointer
